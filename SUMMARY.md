...
* [docs and code](README.md)
  * [pi-hole one line install](docs-and-code/pi-hole-one-line-install.md)
  * [no sudo password prompt for current user](docs-and-code/no-sudo-password-prompt-for-current-user.md)
